    ...
    def record_success(self):
        ...
        if self.consecutive_successes >= 10:
            self.current_delay = max(self.min_delay, 
                                    self.current_delay * self.success_speedup)
    ...
    for attempt in range(retries):
        ...
        try:
            ...
            if e.code == 429:  # Rate limited
                ...
                rate_limiter.record_error(is_rate_limit=True)
                print(f"  Service unavailable, backing off")
            else:
...
def search_ia(query: str, fields: List[str], rows: int, page: int, 
...
Examples:
  ...
  python ia_collector.py --year-end 1914 --dry-run --max-items 100
    ...
    parser.add_argument('--content-type', 
                        ...
                        default='any', help='Filter by content type')
    ...
    fields = [
        ...
        'collection', 'subject', 'description', 'publisher',
        'contributor', 'scanner', 'mediatype', 'downloads'
    ]
